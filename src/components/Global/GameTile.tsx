...
const GameTile = ({name, background, className}: Props) => {
    ...
    return (
        ...
        <>
            <div onMouseEnter={ hoverHandler } className={`group cursor-pointer relative overflow-hidden w-[250px] sm:w-[300px] md:w-[350px] lg:w-[450px] 2xl:w-[600px] h-24 sm:h-32 md:h-38 lg:h-44 2xl:h-52 rounded-3xl bg-purple-500 ${ className }`}>
