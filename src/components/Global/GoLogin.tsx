...
const GoLogin = () => {
    ...
    return (
        <div className="group fixed z-[9999] right-[2%] top-[3%] flex">
            ...
            <div className="bg-black-100/[0.5] backdrop-blur-2xl flex justify-left border-[2px] border-r-0 border-transparent group-hover:border-purple-100/[.2] align-middle rounded-l-xl pl-8 pr-12 py-4 absolute translate-x-[300%] group-hover:-translate-x-[100%] duration-300 -z-10">
