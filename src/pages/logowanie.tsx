    ...
    return (
        <>
            ...
            <div className='h-[100vh] w-full text-white bg-purple-900 m-0 p-0 overflow-hidden relative'>
                <div className="absolute right-[50%] translate-x-[50%] top-[15%] z-50 flex flex-col">
                    <div className="w-[90vw] xl:w-[60vw] 2xl:w-[40vw] bg-black-100/[0.2] h-fit rounded-3xl px-12 py-20 backdrop-blur-3xl flex flex-col gap-4">
                        <div className="mb-12">
                        ...
                        <div className="w-[100%] xl:w-[80%] mx-auto flex flex-col gap-3">
                            ...
                            <Button className="mx-auto mt-12">Zaloguj się</Button>
                        </div>
                    </div>
